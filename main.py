...
class Ssd(LinkedList):
    ...
    def home_interface(self):
        ...
        tk.Label(self.ssd, text="Choose a Data Structure", relief="solid", font="Arial, 40 bold", bg="azure4").pack(
            pady=50)
        ...
        tk.Button(self.ssd, text="Linked List", font="Sans-serif, 20 bold", fg="black", bg="salmon", relief="raised",
                  bd=5,
                  command=self.linkedlist).pack(pady=5)

        tk.Button(self.ssd, text="X", font="Sans-serif, 15 bold", fg="red", bg="PaleVioletRed4", relief="groove", bd=2,
                  command=self.ssd.destroy).place(x=860, y=0)
    ...
    def array_interface_2(self):
        ...
        tk.Label(self.ary, text="Enter array elements:", font="Sans-serif, 20 bold", bg="rosy brown").place(x=300,
                                                                                                            y=230)
        self.array_entries = []
    ...
    def show_array(self):
        ...
        tk.Button(self.out, text="Insert", font="Sans-serif, 15", bg="sandybrown", fg="blue",
                  activeforeground="white", activebackground="grey", command=self.array_insert).pack(pady=10)

        tk.Button(self.out, text="Delete", font="Sans-serif, 15", bg="RosyBrown", fg="blue",
                  activeforeground="white", activebackground="grey", command=self.array_delete).pack(pady=10)
        tk.Button(self.out, text="Search", font="Sans-serif, 15", fg="black", bg="chocolate",
                  command=self.array_search).pack(pady=10)
        tk.Button(self.out, text="Update", font="Sans-serif, 15", fg="black", bg="light salmon3",
                  command=self.array_update).pack(pady=10)

        tk.Button(self.out, text="<", font="Sans-serif, 15 bold", fg="green", bg="salmon", relief="groove", bd=1,
                  command=self.out.destroy).place(x=0, y=0)
        tk.Button(self.out, text="X", font="Sans-serif, 15 bold", fg="red", bg="salmon", relief="groove", bd=2,
                  command=self.ssd.destroy).place(x=860, y=0)
    ...
    def array_insert(self):
        ...
        tk.Label(self.insrt, text="Enter the element you want to insert:", font="Sans-serif, 20 bold",
        ...
        tk.Label(self.insrt, text="Enter the position where you want to insert the element:",
    ...
    def array_delete(self):
        ...
        tk.Button(self.dlt, text="<", font="Sans-serif, 15 bold", fg="green", bg="azure4", relief="groove", bd=1,
                  command=self.dlt.destroy).place(x=0, y=0)
        tk.Button(self.dlt, text="X", font="Sans-serif, 15 bold", fg="red", bg="azure4", relief="groove", bd=2,
                  command=self.ssd.destroy).place(x=860, y=0)
    ...
    def delete_by_index(self):
        ...
        tk.Label(self.dlt_idx, text="Enter the index number you want to delete:", font="Sans-serif, 20 bold",
                 bg="azure4").pack(pady=10)
    ...
    def array_update(self):
        ...
        tk.Label(self.updt, text="Enter the index no. and value respectively: " + str(self.array),
                 font="Sans-serif, 20 bold", bg="azure4").pack(pady=10)
    ...
    def linkedlist(self):
        ...
        self.window = Toplevel(bg="rosy brown")
        ...
        label = Label(self.window, text="Enter the data: ", bg="rosy brown", font="Arial 16 bold")
        label.place(x=210, y=110)

        entryBox = Entry(self.window, width=20, font="Arial 16")
        entryBox.place(x=420, y=110)

        entryLabelX = Label(self.window, text="Enter the X node: ", bg="rosy brown", font="Arial 16 bold")
        ...
        deleteButton = Button(self.window, text="Delete Node", font="Sans-serif, 14", bg="sandy brown", fg="blue",
                              activeforeground="white", activebackground="grey", command=delete_node)
        deleteButton.place(x=383, y=278)

        displayButton = Button(self.window, text="Display List", font="Sans-serif, 14", bg="chocolate", fg="blue",
                               activeforeground="white", activebackground="grey", command=display_list)
        displayButton.place(x=388, y=324)

        scrollbar = Scrollbar(self.window)
        scrollbar.pack(side=RIGHT, fill=Y)

        resultList = Listbox(self.window, width=30, height=15, font="arial 16", yscrollcommand=scrollbar.set)
        resultList.place(x=250, y=400)

        # Configure the scrollbar to work with the Listbox
        scrollbar.config(command=resultList.yview)

        tk.Button(self.window, text="<", font="Sans-serif, 15 bold", fg="green", bg="rosy brown", relief="groove", bd=1,
                  command=self.window.destroy).place(x=0, y=0)
        tk.Button(self.window, text="X", font="Sans-serif, 15 bold", fg="red", bg="rosy brown", relief="groove", bd=2,
                  command=self.ssd.destroy).place(x=860, y=0)
